Feature: Amplitude V10 SMGs Côte d'Ivoire (SGCI)

  Background:
    Given url "https://hvip-f-cbg.dns21.socgen/aif/10/ci"
    And   header Content-Type = "text/xml"
    * def data = read('../../dataset/cote-ivoire.yml')
                ...
                <amp:getAccountActivityRequest>
                    ...
                    <amp:movementPeriod>
                      <amp:historyMovementsOnly>
                        ...
                        <amp:endDate><endDate></amp:endDate>
                      </amp:historyMovementsOnly>
                    </amp:movementPeriod>
                </amp:getAccountActivityRequest>
            </amp:getAccountActivityRequestFlow>
